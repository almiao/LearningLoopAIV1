...
def _validate_training_point(point: Dict[str, Any], index: int) -> Dict[str, Any]:
    ...
    return {
        ...
        "domainId": ensure_string(point.get("domainId") or point.get("abilityDomainId")),
        "domainTitle": ensure_string(point.get("domainTitle") or point.get("abilityDomainTitle")),
...
def _checkpoint_concept_from_point(point: Dict[str, Any], checkpoint: Dict[str, Any]) -> Dict[str, Any]:
    return {
        ...
        "domainId": point.get("domainId", "") or point.get("abilityDomainId", ""),
        "domainTitle": point.get("domainTitle", "") or point.get("abilityDomainTitle", ""),
